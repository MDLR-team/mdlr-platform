...
const CommentsBlockV2: React.FC = () => {
    ...
    <>
      <Paper sx={{ flexDirection: "column" }}>
        ...
        <Header>
          <PromptSearchBar
            prompt={
              "Describe your audience and the type of insights you'd like to provide"
            }
          />
        </Header>
        ...
        <CommentList>
          <List>
            {copilotDialogData.map((item: any, index) => {
              return (
...
export default CommentsBlockV2;
